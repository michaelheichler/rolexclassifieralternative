...
import com.example.cartoonclassification.ml.LiteModelEfficientdetLite4DetectionMetadata2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            LiteModelEfficientdetLite4DetectionMetadata2 model = LiteModelEfficientdetLite4DetectionMetadata2.newInstance(context);

            // Creates inputs for reference.
            TensorImage image = TensorImage.fromBitmap(bitmap);

            // Runs model inference and gets result.
            LiteModelEfficientdetLite4DetectionMetadata2.Outputs outputs = model.process(image);
